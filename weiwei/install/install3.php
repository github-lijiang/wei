...
<html lang="zh-cn"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
	...
	<form class="form-horizontal" method="post" role="form" action="install4.php">
		<div class="panel panel-default">
			...
			<div class="panel-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-4">
                        <input class="form-control" type="text" name="dbport">
                    </div>
                </div>
				<div class="form-group">
				...
				<div class="form-group">
					...
					<div class="col-sm-4">
						<input class="form-control" type="text" name="dbnames" value="we7">
					</div>
				</div>
			</div>
		</div>
		...
		<ul class="pager">
			...
			<li class="previous"><a href="javascript:;" onclick="if(check(this)){jQuery(&#39;#do&#39;).val(&#39;&#39;);if($(&#39;input[name=type]&#39;).val() == &#39;remote&#39;){alert(&#39;在线线安装时，安装程序会下载精简版快速完成安装，完成后请务必注册云服务更新到完整版。&#39;)}$(&#39;form&#39;)[0].submit();}">继续 <span class="glyphicon glyphicon-chevron-right"></span></a></li>
		</ul>
	</form>
	<script>
		var lock = false;
